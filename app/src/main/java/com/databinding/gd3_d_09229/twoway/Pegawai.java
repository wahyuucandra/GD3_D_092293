...
import com.databinding.gd3_d_09229.BR;
...
public class Pegawai extends BaseObservable {
    ...
    public Pegawai(String nama_pegawai, String nomor_pokok, String jabatan,
                   String alamat, double gaji, String tanggal_masuk)
    {
