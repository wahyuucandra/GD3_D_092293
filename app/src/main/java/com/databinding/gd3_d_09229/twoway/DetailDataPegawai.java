...
import com.databinding.gd3_d_09229.databinding.TwoWayBinding;
...
public class DetailDataPegawai extends AppCompatActivity {
    ...
    public View.OnClickListener btnBackClickListener = new View.OnClickListener(){
        ...
        public void onClick(View view) {
            Intent mainActivity = new Intent(DetailDataPegawai.this, com.databinding.gd3_d_09229.twoway.InputDataPegawai.class);
